...
public class Controller {
    ...
    @ApiImplicitParam(name = "medicalOperations", value = "createTime,updateTime,active不传", required = true, dataType = "KabaMedicalOperation")
    ...
    @ApiImplicitParam(name = "medicalOperationAndUser", value = "", required = true, dataType = "Long")
